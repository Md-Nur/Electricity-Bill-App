...
if __name__ == "__main__":
    ...
    title = Label(
        titleFrame, text="✨ঘর ভাড়া ও বিদ্যুৎ বিল✨", font=("Arial", 30), padx=10, pady=10
    )
    title.pack()
    ...
    rate.insert(0, pr101[6])
    rate.grid(row=0, column=5, padx=5, pady=5)

    buttonFrame = Frame(root, padx=10, pady=10)
    buttonFrame.pack()
    button = Button(buttonFrame, text="সাবমিট", font=FONT, command=callBack)
    button.pack()
